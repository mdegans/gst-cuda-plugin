...
#define PACKAGE "gstcudaplugin"
#define PACKAGE_AUTHOR "Michael de Gans"
#define PACKAGE_EMAIL "<michael.john.degans@gmail.com>"
#define GST_PACKAGE_NAME "GStreamer CUDA plugin (USING CONFIG_DEV.H)"
