...
static const char* ELEMENT_TYPE_NAME = "GstDsProtoPayload";
...
GST_START_TEST(test_type) {
  ...
  ck_assert(GST_IS_DSPROTOPAYLOAD(filter));
...
static Suite* dsprotopayload_suite(void) {
